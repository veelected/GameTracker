...
public class BladePage extends AppCompatActivity {
    private static final String TAG = "BladePage";
    ListView lv_Blayout;
    List<String> arrayBladeList = new ArrayList<String>();
    BladeList bladeList = new BladeList();
    ArrayAdapter adB;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv_Blayout = findViewById(R.id.bladeLayout);
        tv_bladeListLeft = findViewById(R.id.tv_bladeListLeft);

        //adapter set
        arrayBladeList = new ArrayList<String>(Arrays.asList(bladeList.BladesListBig));

        adB = new ArrayAdapter(this, android.R.layout.select_dialog_multichoice, arrayBladeList);
        lv_Blayout.setAdapter(adB);
...
load();
        ...
        lv_Blayout.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                int ammount;
                ammount = arrayBladeList.size();
//                Toast.makeText(BladePage.this, "position" + position + "size" + ammount, Toast.LENGTH_SHORT).show();
                if (lv_Blayout.isItemChecked(position)) {
                    listLeft = listLeft - 1;
                } else {
                    listLeft = listLeft + 1;
                }
                ...
                boxcheck2 = lv_Blayout.isItemChecked(2);
                boxcheck3 = lv_Blayout.isItemChecked(3);
                boxcheck4 = lv_Blayout.isItemChecked(4);
                boxcheck5 = lv_Blayout.isItemChecked(5);
                boxcheck6 = lv_Blayout.isItemChecked(6);
                boxcheck7 = lv_Blayout.isItemChecked(7);
                boxcheck8 = lv_Blayout.isItemChecked(8);
                boxcheck9 = lv_Blayout.isItemChecked(9);
                boxcheck10 = lv_Blayout.isItemChecked(10);
                boxcheck11 = lv_Blayout.isItemChecked(11);
                boxcheck12 = lv_Blayout.isItemChecked(12);
                boxcheck13 = lv_Blayout.isItemChecked(13);
                boxcheck14 = lv_Blayout.isItemChecked(14);
                boxcheck15 = lv_Blayout.isItemChecked(15);
                boxcheck16 = lv_Blayout.isItemChecked(16);
                boxcheck17 = lv_Blayout.isItemChecked(17);
                boxcheck18 = lv_Blayout.isItemChecked(18);
                boxcheck19 = lv_Blayout.isItemChecked(19);
                boxcheck20 = lv_Blayout.isItemChecked(20);
                boxcheck21 = lv_Blayout.isItemChecked(21);
                boxcheck22 = lv_Blayout.isItemChecked(22);
                boxcheck23 = lv_Blayout.isItemChecked(23);
                boxcheck24 = lv_Blayout.isItemChecked(24);
                boxcheck25 = lv_Blayout.isItemChecked(25);
                boxcheck26 = lv_Blayout.isItemChecked(26);
                boxcheck27 = lv_Blayout.isItemChecked(27);
                boxcheck28 = lv_Blayout.isItemChecked(28);
                boxcheck29 = lv_Blayout.isItemChecked(29);
                boxcheck30 = lv_Blayout.isItemChecked(30);
                boxcheck31 = lv_Blayout.isItemChecked(31);
                boxcheck32 = lv_Blayout.isItemChecked(32);
                boxcheck33 = lv_Blayout.isItemChecked(33);
                boxcheck34 = lv_Blayout.isItemChecked(34);
                boxcheck35 = lv_Blayout.isItemChecked(35);
                boxcheck36 = lv_Blayout.isItemChecked(36);
                boxcheck37 = lv_Blayout.isItemChecked(37);
                boxcheck38 = lv_Blayout.isItemChecked(38);
                boxcheck39 = lv_Blayout.isItemChecked(39);
                boxcheck40 = lv_Blayout.isItemChecked(40);
                boxcheck41 = lv_Blayout.isItemChecked(41);
                boxcheck42 = lv_Blayout.isItemChecked(42);
                boxcheck43 = lv_Blayout.isItemChecked(43);
                boxcheck44 = lv_Blayout.isItemChecked(44);
                boxcheck45 = lv_Blayout.isItemChecked(45);
                boxcheck46 = lv_Blayout.isItemChecked(46);
                boxcheck47 = lv_Blayout.isItemChecked(47);
                boxcheck48 = lv_Blayout.isItemChecked(48);
                boxcheck49 = lv_Blayout.isItemChecked(49);
                boxcheck50 = lv_Blayout.isItemChecked(50);
                boxcheck51 = lv_Blayout.isItemChecked(51);
                boxcheck52 = lv_Blayout.isItemChecked(52);
                boxcheck53 = lv_Blayout.isItemChecked(53);
                boxcheck54 = lv_Blayout.isItemChecked(54);
                boxcheck55 = lv_Blayout.isItemChecked(55);
                boxcheck56 = lv_Blayout.isItemChecked(56);
                boxcheck57 = lv_Blayout.isItemChecked(57);
                boxcheck58 = lv_Blayout.isItemChecked(58);
                boxcheck59 = lv_Blayout.isItemChecked(59);
                boxcheck60 = lv_Blayout.isItemChecked(60);
                boxcheck61 = lv_Blayout.isItemChecked(61);
                boxcheck62 = lv_Blayout.isItemChecked(62);
                boxcheck63 = lv_Blayout.isItemChecked(63);
                boxcheck64 = lv_Blayout.isItemChecked(64);
                boxcheck65 = lv_Blayout.isItemChecked(65);
                boxcheck66 = lv_Blayout.isItemChecked(66);
                boxcheck67 = lv_Blayout.isItemChecked(67);
                boxcheck68 = lv_Blayout.isItemChecked(68);
                boxcheck69 = lv_Blayout.isItemChecked(69);
                boxcheck70 = lv_Blayout.isItemChecked(70);
                boxcheck71 = lv_Blayout.isItemChecked(71);
                boxcheck72 = lv_Blayout.isItemChecked(72);
                boxcheck73 = lv_Blayout.isItemChecked(73);
                boxcheck74 = lv_Blayout.isItemChecked(74);
                boxcheck75 = lv_Blayout.isItemChecked(75);
                boxcheck76 = lv_Blayout.isItemChecked(76);
                boxcheck77 = lv_Blayout.isItemChecked(77);
                boxcheck78 = lv_Blayout.isItemChecked(78);
                boxcheck79 = lv_Blayout.isItemChecked(79);
                boxcheck80 = lv_Blayout.isItemChecked(80);
                boxcheck81 = lv_Blayout.isItemChecked(81);
                boxcheck82 = lv_Blayout.isItemChecked(82);
                boxcheck83 = lv_Blayout.isItemChecked(83);
                boxcheck84 = lv_Blayout.isItemChecked(84);
                boxcheck85 = lv_Blayout.isItemChecked(85);
                boxcheck86 = lv_Blayout.isItemChecked(86);
                boxcheck87 = lv_Blayout.isItemChecked(87);
                boxcheck88 = lv_Blayout.isItemChecked(88);
                boxcheck89 = lv_Blayout.isItemChecked(89);
                boxcheck90 = lv_Blayout.isItemChecked(90);
                boxcheck91 = lv_Blayout.isItemChecked(91);
                boxcheck92 = lv_Blayout.isItemChecked(92);
                boxcheck93 = lv_Blayout.isItemChecked(93);
                boxcheck94 = lv_Blayout.isItemChecked(94);
                boxcheck95 = lv_Blayout.isItemChecked(95);
                boxcheck96 = lv_Blayout.isItemChecked(96);
                boxcheck97 = lv_Blayout.isItemChecked(97);
                boxcheck98 = lv_Blayout.isItemChecked(98);
                boxcheck99 = lv_Blayout.isItemChecked(99);
                boxcheck100 = lv_Blayout.isItemChecked(100);
    ...
    private void save() {
        ...
        editor.putInt("listKEY", listLeft);
    ...
    private void update() {
        ...
        if (boxcheck1) lv_Blayout.setItemChecked(1, true);
        if (boxcheck2) lv_Blayout.setItemChecked(2, true);
        if (boxcheck3) lv_Blayout.setItemChecked(3, true);
        if (boxcheck4) lv_Blayout.setItemChecked(4, true);
        if (boxcheck5) lv_Blayout.setItemChecked(5, true);
        if (boxcheck6) lv_Blayout.setItemChecked(6, true);
        if (boxcheck7) lv_Blayout.setItemChecked(7, true);
        if (boxcheck8) lv_Blayout.setItemChecked(8, true);
        if (boxcheck9) lv_Blayout.setItemChecked(9, true);
        if (boxcheck10) lv_Blayout.setItemChecked(10, true);
        if (boxcheck11) lv_Blayout.setItemChecked(11, true);
        if (boxcheck12) lv_Blayout.setItemChecked(12, true);
        if (boxcheck13) lv_Blayout.setItemChecked(13, true);
        if (boxcheck14) lv_Blayout.setItemChecked(14, true);
        if (boxcheck15) lv_Blayout.setItemChecked(15, true);
        if (boxcheck16) lv_Blayout.setItemChecked(16, true);
        if (boxcheck17) lv_Blayout.setItemChecked(17, true);
        if (boxcheck18) lv_Blayout.setItemChecked(18, true);
        if (boxcheck19) lv_Blayout.setItemChecked(19, true);
        if (boxcheck20) lv_Blayout.setItemChecked(20, true);
        if (boxcheck21) lv_Blayout.setItemChecked(21, true);
        if (boxcheck22) lv_Blayout.setItemChecked(22, true);
        if (boxcheck23) lv_Blayout.setItemChecked(23, true);
        if (boxcheck24) lv_Blayout.setItemChecked(24, true);
        if (boxcheck25) lv_Blayout.setItemChecked(25, true);
        if (boxcheck26) lv_Blayout.setItemChecked(26, true);
        if (boxcheck27) lv_Blayout.setItemChecked(27, true);
        if (boxcheck28) lv_Blayout.setItemChecked(28, true);
        if (boxcheck29) lv_Blayout.setItemChecked(29, true);
        if (boxcheck30) lv_Blayout.setItemChecked(30, true);
        if (boxcheck31) lv_Blayout.setItemChecked(31, true);
        if (boxcheck32) lv_Blayout.setItemChecked(32, true);
        if (boxcheck33) lv_Blayout.setItemChecked(33, true);
        if (boxcheck34) lv_Blayout.setItemChecked(34, true);
        if (boxcheck35) lv_Blayout.setItemChecked(35, true);
        if (boxcheck36) lv_Blayout.setItemChecked(36, true);
        if (boxcheck37) lv_Blayout.setItemChecked(37, true);
        if (boxcheck38) lv_Blayout.setItemChecked(38, true);
        if (boxcheck39) lv_Blayout.setItemChecked(39, true);
        if (boxcheck40) lv_Blayout.setItemChecked(40, true);
        if (boxcheck41) lv_Blayout.setItemChecked(41, true);
        if (boxcheck42) lv_Blayout.setItemChecked(42, true);
        if (boxcheck43) lv_Blayout.setItemChecked(43, true);
        if (boxcheck44) lv_Blayout.setItemChecked(44, true);
        if (boxcheck45) lv_Blayout.setItemChecked(45, true);
        if (boxcheck46) lv_Blayout.setItemChecked(46, true);
        if (boxcheck47) lv_Blayout.setItemChecked(47, true);
        if (boxcheck48) lv_Blayout.setItemChecked(48, true);
        if (boxcheck49) lv_Blayout.setItemChecked(49, true);
        if (boxcheck50) lv_Blayout.setItemChecked(50, true);
        if (boxcheck51) lv_Blayout.setItemChecked(51, true);
        if (boxcheck52) lv_Blayout.setItemChecked(52, true);
        if (boxcheck53) lv_Blayout.setItemChecked(53, true);
        if (boxcheck54) lv_Blayout.setItemChecked(54, true);
        if (boxcheck55) lv_Blayout.setItemChecked(55, true);
        if (boxcheck56) lv_Blayout.setItemChecked(56, true);
        if (boxcheck57) lv_Blayout.setItemChecked(57, true);
        if (boxcheck58) lv_Blayout.setItemChecked(58, true);
        if (boxcheck59) lv_Blayout.setItemChecked(59, true);
        if (boxcheck60) lv_Blayout.setItemChecked(60, true);
        if (boxcheck61) lv_Blayout.setItemChecked(61, true);
        if (boxcheck62) lv_Blayout.setItemChecked(62, true);
        if (boxcheck63) lv_Blayout.setItemChecked(63, true);
        if (boxcheck64) lv_Blayout.setItemChecked(64, true);
        if (boxcheck65) lv_Blayout.setItemChecked(65, true);
        if (boxcheck66) lv_Blayout.setItemChecked(66, true);
        if (boxcheck67) lv_Blayout.setItemChecked(67, true);
        if (boxcheck68) lv_Blayout.setItemChecked(68, true);
        if (boxcheck69) lv_Blayout.setItemChecked(69, true);
        if (boxcheck70) lv_Blayout.setItemChecked(70, true);
        if (boxcheck71) lv_Blayout.setItemChecked(71, true);
        if (boxcheck72) lv_Blayout.setItemChecked(72, true);
        if (boxcheck73) lv_Blayout.setItemChecked(73, true);
        if (boxcheck74) lv_Blayout.setItemChecked(74, true);
        if (boxcheck75) lv_Blayout.setItemChecked(75, true);
        if (boxcheck76) lv_Blayout.setItemChecked(76, true);
        if (boxcheck77) lv_Blayout.setItemChecked(77, true);
        if (boxcheck78) lv_Blayout.setItemChecked(78, true);
        if (boxcheck79) lv_Blayout.setItemChecked(79, true);
        if (boxcheck80) lv_Blayout.setItemChecked(80, true);
        if (boxcheck81) lv_Blayout.setItemChecked(81, true);
        if (boxcheck82) lv_Blayout.setItemChecked(82, true);
        if (boxcheck83) lv_Blayout.setItemChecked(83, true);
        if (boxcheck84) lv_Blayout.setItemChecked(84, true);
        if (boxcheck85) lv_Blayout.setItemChecked(85, true);
        if (boxcheck86) lv_Blayout.setItemChecked(86, true);
        if (boxcheck87) lv_Blayout.setItemChecked(87, true);
        if (boxcheck88) lv_Blayout.setItemChecked(88, true);
        if (boxcheck89) lv_Blayout.setItemChecked(89, true);
        if (boxcheck90) lv_Blayout.setItemChecked(90, true);
        if (boxcheck91) lv_Blayout.setItemChecked(91, true);
        if (boxcheck92) lv_Blayout.setItemChecked(92, true);
        if (boxcheck93) lv_Blayout.setItemChecked(93, true);
        if (boxcheck94) lv_Blayout.setItemChecked(94, true);
        if (boxcheck95) lv_Blayout.setItemChecked(95, true);
        if (boxcheck96) lv_Blayout.setItemChecked(96, true);
        if (boxcheck97) lv_Blayout.setItemChecked(97, true);
